...
<p>In texts giving Internet history a serious treatment, such as the 1996 <a href="//archive.org/details/wherewizardsstay00haf_vgj/">“Where Wizards Stay Up Late - The Origin of the Internet”</a> you can <a href="//archive.org/details/wherewizardsstay00haf_vgj/page/n4/mode/2up?q=nuclear">search the word “nuclear”</a> and come up with passages like:</p>
<blockquote>
...
<p>See you glazed over that. I know it. Isn’t <a href="//jacobin.com/2022/06/internet-privatization-profit-centralization-democracy">“bringing the mainframe to the battlefield”</a> more sexy? That’s from June 2022.</p>
...
<p>If you click through the above article you'll see a linguistic phenomena: It's called Internet without the word "the" preceding it. This was pretty common through 1994. Here's <a href="//youtu.be/U_o8gerare0?t=189">The Computing Chronicles S11E7 from 1993/03</a> doing their "history of Internet".</p>
...
<p><a href="//en.wikipedia.org/wiki/DARPA">DARPA</a>, the organization that funded the development of ARPANET in the 1960s (The "D" was added to ARPA in 1972) has a similar story in <a href="//www.researchgate.net/publication/235051902_DARPA_Technical_Accomplishments_An_Historical_Review_of_Selected_DARPA_Projects_Volume_1">“DARPA Technical Accomplishments”</a>, from 1990. ARPANET is in the “Information Processing” section claiming it's part of a larger “batch-processing” to “time-sharing” revolution (<a href="#time-sharing">more about this later</a>). From section 20-1:</p>
<blockquote>
...
<p>So apparently the Internet is becoming a big deal. The first prominent and more direct "Internet was designed to survive bombs" connection is in <a href="//archive.org/details/wholeinternetuse00krol/page/10/mode/2up">“The Whole Internet User’s Guide &amp; Catalog” from September 1992</a> by <a href="//en.wikipedia.org/wiki/Ed_Krol">Ed Krol</a>. This is one of those books that’s so successful he came back to pen two sequels. <a href="//www.amazon.com/Internet-Catalog-Intanetto-yuzazu-Japanese/dp/4900718122/">Amazon even sells a Japanese version</a>. Here, near the beginning of the book, we get our narrative. However, instead of “nuclear” it’s an unspecified “bomb attack”:</p>
<figure>
...
<p>This is an honest error connecting a project that didn’t get approved, the bomb resilient network Paul Baran proposed to the Air Force, with the ARPA Network project (more on both of these later). Specifically this is referring to what Baran called <a href="//www.rand.org/content/dam/rand/pubs/research_memoranda/2006/RM3103.pdf">“hot-potato routing”</a> in 1964.</p>
...
<p>This connection can be found in other texts such as 1994’s <a href="//archive.org/details/internetconnecti0000quar/page/20/mode/2up">“The Internet connection: system connectivity and configuration”</a> where the author, <a href="//en.wikipedia.org/wiki/John_Quarterman">John Quarterman</a> states without citation (going back to our "common knowledge" definition above) in a section titled “Surviving a Nuclear War” a very similar passage he stated in a 1993 text co-authored with <a href="//www.linkedin.com/in/carlmitchell/">Smoot Carl-Mitchell</a>&dagger;, <a href="//archive.org/details/practicalinterne0000carl/page/4/mode/2up">“Practical Internetworking with TCP/IP and Unix”</a>:</p>
<figure>
...
<p>It’s worth noting that John Quarterman might have had his mind changed on this. In an earlier, widely cited, 1990 text by him, <a href="//archive.org/details/matrixcomputernet00quar/page/142/mode/2up">"The Matrix: Computer Networks and Conferencing Systems Worldwide"</a>, he used a citation, suggesting we haven't entered a common knowledge phase, and told a much more ARPA history as follows:</p>
<blockquote>
...
<p>It's 1994! Along with GeoCitites, Lycos and CDNow, we get perhaps the first claim of a direct causal connection from <a href="//www.google.com/books/edition/INSCOM_Journal/wqkrAAAAYAAJ?hl=en&amp;gbpv=1&amp;pg=RA3-PA10&amp;printsec=frontcover">INSCOM (Army Intelligence &amp; Security Command) in March 1994 on page 10</a>:</p>
<blockquote>
...
<p>We also find the older narrative “ARPANET is an indirect consequence of nuclear war planning” starting to become "common knowledge" such as in <a href="//www.google.com/books/edition/Japanese_Technical_Literature_Bulletin/gLIvm9n9a3EC?hl=en&amp;gbpv=1&amp;pg=RA7-PA5&amp;printsec=frontcover">“Japan’s Information Highway” from Nov 26, 1994</a>, also uncited:</p>
<blockquote>
...
<p>By now the nuclear narrative has become "common knowledge" so people start making logical inferences from it in official documents such as the US Congressional Office of Technology Assessment's <a href="//www.google.com/books/edition/Global_Communications/m4keIKypadcC?hl=en&amp;gbpv=1&amp;pg=PA102&amp;printsec=frontcover">“Global Communications: Opportunities for Trade and Aid.”</a> from 1995, page 102:</p>
<blockquote>
...
<p>You even get hybrids combining multiple narrative strains. Watch it grow in the 1995 academic text, <a href="//www.google.com/books/edition/Technology_in_the_national_interest/jEqFQv1P_UYC?hl=en&amp;gbpv=1&amp;pg=PA66&amp;printsec=frontcover">“Technology in The National Interest”</a>:</p>
<blockquote>
...
<p>After that it was off to the races, such as in this 1995 text, <a href="//archive.org/details/vrmlbrowsingbuil00pesc/page/10/mode/2up">"VRML Browsing &amp; Building Cyberspace: The Definitive Resource for VRML Technology"</a>:</p>
<figure>
...
<p>
The first article about ARPANET I could find was before it was called ARPANET. In September of 1968, <a href="//archive.org/details/bitsavers_Electronic9680916_134517369/page/62/mode/2up">Electronics Magazine</a>:
<blockquote>
  <p>
...
<p>To make an attempt to discover this, a corpus of 13.5 billion <a href="//files.pushshift.io/reddit/comments/">Reddit comments</a> were analyzed with <a href="//github.com/kristopolous/sf/blob/main/narrative-extractor.sh">a complex regex yielding 191,725 candidate comments</a>. Then <a href="//github.com/kristopolous/sf/blob/main/narrative-counter.py">a second pass was done</a> using a naive Regex classifier with another naive way to see if the user is negating (as in saying "arpanet was not about ww3"). No stemming, tokenizing or lemmatization was done; scikit wasn't even included. This is certainly ongoing research. (<a href="//en.wikipedia.org/wiki/BERT_(language_model)">BERT Transformers</a> are the most likely next approach along with also using the <a href="//files.pushshift.io/hackernews/">hn corpus</a>.)</p>
...
<p>The work they are referring to is entitled <a href="//archive.org/details/RecommendationToTheAirStaff/mode/2up">“Recommendation to the Air Staff”</a> by RAND, from August 1965. Quoting page 2:</p>
<blockquote>
...
<p>Also, the Internet is not the ARPANET, as Quarterman pointed out in a few texts, this one from <a href="//archive.org/details/sim_computerworld_1993-02-22_27_7/page/n85/mode/2up">Computerworld, Feb 22, 1993</a>:</p>
...
<p>These two (P) links might negate the (A) links and his direct participation does fall under the definition (albeit 15 years later so maybe not). Unless I can find a way to contact Krol, I'll have to leave that question mark there.</p</li>
  ...
  <li id="sterling"><p>Sterling doesn't directly quote anyone in his February 1993 story however, in his November 1992 text, <a href="//www.mit.edu/hacker/hacker.html">"The Hacker Crackdown: Law and Disorder on the Electronic Frontier"</a> he talks about a <a href="//www.mit.edu/hacker/part4.html">1991 CPSR roundtable</a> mentioning two Peers:</p>
